...
import kotlinx.android.synthetic.main.fragment_region_oceania.*
import org.koin.android.ext.android.inject

/**
 * A simple [Fragment] subclass.
 */
class RegionOceaniaFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_region_oceania, container, false)
    }
    ...
    private fun init() {
        btn_oceania_all.setOnClickListener(this)
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(Number: Int): RegionOceaniaFragment {
            return RegionOceaniaFragment().apply {
