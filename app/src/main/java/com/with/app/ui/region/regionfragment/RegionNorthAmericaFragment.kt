...
import kotlinx.android.synthetic.main.fragment_region_north_america.*
import org.koin.android.ext.android.inject

/**
 * A simple [Fragment] subclass.
 */
class RegionNorthAmericaFragment : Fragment(), View.OnClickListener {
    ...
    private fun init() {
        btn_north_america_all.setOnClickListener(this)
    }
    ...
    companion object {
        ...
        fun newInstance(Number: Int): RegionNorthAmericaFragment {
            return RegionNorthAmericaFragment()
                .apply {
