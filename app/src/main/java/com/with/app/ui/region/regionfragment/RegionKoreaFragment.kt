...
import kotlinx.android.synthetic.main.fragment_region_korea.*
import org.koin.android.ext.android.inject

/**
 * A simple [Fragment] subclass.
 */
class RegionKoreaFragment : Fragment(), View.OnClickListener{
    ...
    private fun init() {
        btn_korea_all.setOnClickListener(this)
    }
